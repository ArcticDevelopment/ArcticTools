...
public class ArcticTools extends JavaPlugin {
    ...
    private void registerFish() {
        ...
        new FishDrop(item, FishDropRarity.BASIC,1*1000);
        ...
        new FishDrop(item1, FishDropRarity.BASIC,2*1000);
        ...
        new FishDrop(item2, FishDropRarity.ENCHANTED,5*1000);
        ...
        new FishDrop(item3, FishDropRarity.ENCHANTED,7*1000);
        ...
        new FishDrop(item4, FishDropRarity.ENCHANTED,9*1000);
        ...
        new FishDrop(item5, FishDropRarity.ENCHANTED,9*1000);
        ...
        new FishDrop(item6, FishDropRarity.ENCHANTED,7*1000);
        ...
        new FishDrop(item7, FishDropRarity.MYSTICAL,16*1000);
        ...
        new FishDrop(item8, FishDropRarity.MYSTICAL,17*1000);
        ...
        new FishDrop(item9, FishDropRarity.MYSTICAL,15*1000);
        ...
        new FishDrop(item10, FishDropRarity.LEGENDARY,20*1000);
        ...
        new FishDrop(item11, FishDropRarity.LEGENDARY,25*1000);
        ...
        new FishDrop(item12, FishDropRarity.DIVINE,30*1000);
        ...
        new FishDrop(item13, FishDropRarity.DIVINE,35*1000);
        ...
        new FishDrop(item14, FishDropRarity.DIVINE,40*1000);
    }
}
